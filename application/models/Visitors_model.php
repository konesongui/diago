...
class visitors_model extends MY_Model {
    ...
    public function visitors_listes($id = null) {
        $this->db->select()->from('recrutement');
        if ($id != null) {
    ...
    public function deletecate($id) {
        ...
        //=======================Code Start===========================
        $this->db->where('id', $id);
        $this->db->delete('categorie_salarie');
    ...
    public function images_deletecat($id, $img_name) {
        $file = "./uploads/front_office/categorie_salaire/" . $img_name;
        unlink($file);
        $this->db->where('id', $id);
        $this->db->delete('categorie_salaire');
        $controller_name = $this->uri->segment(2);
