...
class Staffcertificate extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->session->set_userdata('sub_menu', 'admin/staffcertificate');
        $data['generated_code'] = random_string('alnum', 8);

        $this->data['staffidcardlist'] = $this->Staffidcard_model->staffidcardlist();

        $this->load->view('layout/header');
        $this->load->view('admin/staffcertificate/staffcertificateView', $data);
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            redirect('admin/staffcertificate/index');
        }
        $this->data['staffidcardlist'] = $this->Staffidcard_model->staffidcardlist();
        $this->load->view('layout/header');
        $this->load->view('admin/staffcertificate/staffcertificateView', $this->data);
        $this->load->view('layout/footer');
    }
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->data['staffidcardlist'] = $this->Staffidcard_model->staffidcardlist();
            $this->load->view('layout/header');
            $this->load->view('admin/staffcertificate/staffcertificateedit', $this->data);
            $this->load->view('layout/footer');
        } else {
            $staff_id          = 0;
            $department        = 0;
            ...
            redirect('admin/staffcertificate');
        }
    }
    ...
    public function delete($id)
    {
        ...
        redirect('admin/staffcertificatelist/index');
    }
    ...
    public function view()
    {
        ...
        $this->load->view('admin/staffcertificate/staffcertificatepreview', $data);
    }
