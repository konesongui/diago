...
class Staffcertificatelist extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->session->set_userdata('sub_menu', 'admin/staffcertificatelist');
        $this->data['staffidcardlist'] = $this->Staffidcard_model->staffidcardlist();

        $this->load->view('layout/header');
        $this->load->view('admin/staffcertificatelist/staffcertificatelistView', $this->data);
