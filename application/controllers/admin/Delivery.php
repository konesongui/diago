...
class Delivery extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->session->set_userdata('sub_menu', 'delivery/index');
        $data['title'] = 'Add Issue item';
        $data['title_list'] = 'Recent Issue items';
        $this->load->view('layout/header', $data);
        $this->load->view('admin/delivery/deliveryList', $data);
    ...
    public function create() {
        ...
        $data['clientslist'] = $this->clients_model->get();

        $this->load->view('layout/header', $data);
        $this->load->view('admin/delivery/deliveryCreate', $data);
        $this->load->view('layout/footer', $data);
    }
    ...
    function add() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->itemissue_model->adds($data);
     ...
     public function getdeliverylist()
    {
        ...
        $m       = $this->itemissue_model->getdeliverylist();
        $m       = json_decode($m);
