...
class Ventes extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->session->set_userdata('sub_menu', 'ventes/index');
        $data['title'] = 'Add Issue item';
        $data['title_list'] = 'Recent Issue items';
        $this->load->view('layout/header', $data);
        $this->load->view('admin/ventes/ventesList', $data);
    ...
    public function create() {
        ...
        $this->load->view('layout/header', $data);
        $this->load->view('admin/ventes/VentesCreate', $data);
        $this->load->view('layout/footer', $data);
    }
