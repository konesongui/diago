            ...
            if ($this->rbac->hasPrivilege('staff_id_card', 'can_add') || $this->rbac->hasPrivilege('staff_id_card', 'can_edit')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form id="form1" enctype="multipart/form-data" action="<?php echo site_url('admin/staffcertificate/edit/') . $editstaffidcard[0]->id ?>"  id="certificateform" name="certificateform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Titre du certificat</label><small class="req"> *</small>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Informations</label><small class="req"> *</small>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Sous titre</label><small class="req"> *</small>
                                ...
                                <div class="form-group">
                                    <label>Code </label>
                                    <input id="header_color"  name="generated_code" placeholder="" type="text" class="form-control my-colorpicker1"  value="<?php echo set_value('header_color', $editstaffidcard[0]->generated_code); ?>" readonly />
                                </div>
            ...
            ?>">
               ...
               <div class="box box-primary" id="hroom">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">Formulaire de création de design du certificat</h3>
                    </div>
               </div>
                   <!-- <div class="box-body">
                                    ...
                                    foreach ($staffidcardlist as $staffidcards_value) {
                                        ...
                                        <tr>
                                            <td class="mailbox-name">
                                                <a href="#" data-toggle="popover" class="detail_popover" ><?php echo $staffidcards_value->school_name; ?></a>
                                            </td>
                                            <td class="mailbox-name">
                                            ...
                                            <td class="mailbox-date pull-right no-print white-space-nowrap">
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('staff_id_card', 'can_edit')) { ?>
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/staffcertificate/edit/<?php echo $staffidcards_value->id ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                ...
                                                if ($this->rbac->hasPrivilege('staff_id_card', 'can_delete')) {
                                                    ?>
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/staffcertificate/delete/<?php echo $staffidcards_value->id ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
