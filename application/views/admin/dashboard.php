...
if (($this->module_lib->hasActive('fees_collection')) || ($this->module_lib->hasActive('depense'))) {
    if ($this->rbac->hasPrivilege('fees_collection_and_depense_monthly_chart', 'can_view')) {
...
if ($this->module_lib->hasActive('caisse')) {
    if ($this->rbac->hasPrivilege('caisse_donut_graph', 'can_view')) {
        ?>
...
$line_chart = true;
if (($this->module_lib->hasActive('fees_collection')) || ($this->module_lib->hasActive('depense'))) {
    if ($this->rbac->hasPrivilege('fees_collection_and_depense_yearly_chart', 'can_view')) {
        $div_rol = 3;
        ?>
                    <div class="col-lg-7 col-md-7 col-sm-12 col60">
...
if ($this->module_lib->hasActive('depense')) {
    ?>
    <?php if ($this->rbac->hasPrivilege('depense_donut_graph', 'can_view')) {
        ?>
                    <div class="col-lg-5 col-md-5 col-sm-12 col40">
                        <div class="box box-primary borderwhite">
...
if ($this->rbac->hasPrivilege('monthly_depense_widget', 'can_view')) {
    $widget_col[1] = 2;
    $div_rol       = 3;
}
                                    ...
                                    <div class="info-box">
                                        <a href="<?php echo site_url('admin/expense') ?>">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span class="info-box-number"><?php echo $month_expense .$currency_symbol; ?></span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="info-box">
                <a href="#">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Nombre de femmes</span>
...
if ($this->module_lib->hasActive('depense')) {
    if ($this->rbac->hasPrivilege('monthly_depense_widget', 'can_view')) {
        ...
        <div class="col-md-4 col-sm-6">
            <div class="info-box">
                <a href="<?php echo site_url('admin/expense') ?>">
                    <span class="info-box-icon bg-orange"><i class="fa fa-male"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text">Nombre d'hommes</span>
                        <span class="info-box-number"><?php
                ...
                <div class="row">
                    <form role="form"  id="addevent_form" method="post" enctype="multipart/form-data" action="">
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line(''); ?> <?php echo $this->lang->line('title'); ?></label><small class="req"> *</small>
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('') . " " . $this->lang->line('from') ?></label>
                        ...
                        <div class="form-group col-md-6">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('') . " " . $this->lang->line('to') ?></label>
                            <div class="input-group">
                                <div class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                </div>
                        ...
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line(''); ?> <?php echo $this->lang->line('color'); ?></label>
...
?>
                        ...
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line(''); ?> <?php echo $this->lang->line('type'); ?></label>
                            <br/>
...
<script type="text/javascript">
 <?php if ($this->rbac->hasPrivilege('caisse_donut_graph', 'can_view')) {
    ?>
...
if ($s == 8) {
    ...
    <?php
}if ($this->rbac->hasPrivilege('depense_donut_graph', 'can_view')) {
    ?>
...
if ($this->rbac->hasPrivilege('fees_collection_and_depense_yearly_chart', 'can_view')) {
        ...
        labels: current_month_days,
         ...
         <?php }if ($this->rbac->hasPrivilege('fees_collection_and_depense_monthly_chart', 'can_view')) {?>
        if (bar_chart) {
             var current_month_days = <?php echo json_encode($current_month_days) ?>;
        var days_collection = <?php echo json_encode($days_collection) ?>;
        var days_expense = <?php echo json_encode($days_expense) ?>;
