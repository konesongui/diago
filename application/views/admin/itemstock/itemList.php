                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/itemstock"  id="itemstockform" name="itemstockform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Produit</label><small class="req"> *</small>
            ...
            ?> ">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"> Liste des achats</h3>
                        ...
                        <div class="mailbox-messages table-responsive">
                            ...
                            <table class="table table-hover table-striped table-bordered example">
                                <thead>
                                    <tr>
                                        <th>Produit</th>
                                        <th><?php echo $this->lang->line('category'); ?> du produit</th>
