                                    ...
                                    <div class="panel box box-primary">
                                        <div class="box-header with-border">
                                            ...
                                            <div class="pull-right pt5">
                                                <?php if (($this->rbac->hasPrivilege('panneau_notifications', 'can_edit')) || ($notification["created_id"] == $user_id)) { ?>
                                                    ...
                                                    &nbsp; 
                                                    <?php
                                                } if (($this->rbac->hasPrivilege('panneau_notifications', 'can_delete')) || ($notification["created_id"] == $user_id)) {
                                                    ?>
