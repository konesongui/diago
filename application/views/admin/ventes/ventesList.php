...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-object-group"></i>Liste des ventes
        </h1>
    </section>
    <!-- Main content -->
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('vente', 'can_add')) {
                                ?>
                                <a href="<?php echo site_url('admin/ventes/create') ?>" type="button" class="btn btn-primary btn-sm" ><i class="fa fa-plus"></i> Ajouter une vente</a>
                            <?php }
                            ?>
