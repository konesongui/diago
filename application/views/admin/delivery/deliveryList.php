...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-object-group"></i> Liste des bon de livraison
        </h1>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"> Liste des bon de livraison</h3>
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('issue_item', 'can_add')) {
                                ?>
                                <a href="<?php echo site_url('admin/delivery/create') ?>" type="button" class="btn btn-primary btn-sm" ><i class="fa fa-plus"></i> Créer un bon de livraison</a>
                            <?php }
                            ?>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.btn-ok', function () {
        ...
        $.ajax(
                {
                    url: "<?php echo site_url('admin/delivery/returnItem') ?>",
                    type: "POST",
...
<script>
    ...
    'use strict';
    $(document).ready(function () {
        initDatatable('item-list','admin/delivery/getdeliverylist',[],[],100);
    });
} ( jQuery ) )
</script>