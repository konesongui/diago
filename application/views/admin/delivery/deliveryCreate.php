        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form  action="<?php echo site_url('admin/delivery/add') ?>"  id="issueitem" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-12" id="sale-container">
                                    <div class="row">


                                        <button type="button" id="add-sale">Add More</button>
                                        <br><br>
                                        <div class="form-group col-sm-4">
                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('item_category'); ?></label><small class="req"> *</small>

                                            <select  id="item_d" name="item_id[]" class="form-control" >
                                                <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                <?php
                                                foreach ($itemslist as $items) {
                                                    ?>
                                                    <option value="<?php echo $items['id'] ?>"<?php
                                                    if (set_value('item_d') == $items['id']) {
                                                        echo "selected = selected";
                                                    }
                                                    ?>><?php echo $items['name'] ?></option>
...
<script type="text/javascript">
    ...
    function getIssueUser(usertype) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + "admin/delivery/getUser",
        ...
        $.ajax(
            {
                ...
                success: function (data, textStatus, jqXHR)
                {
                    if (data.status == "fail") {
                        ...
                        document.getElementById("delivery").reset();
