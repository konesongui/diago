...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><i class="fa fa-building-o"></i> Ajouter un bon de commande</h1>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Ajouter un bon de commande</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->

                    <form  action="<?php echo site_url('admin/ventes/add') ?>"  id="issueitem" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 col-sm-4">
                                    <label for="exampleInputEmail1">Code de bon</label><small class="req"> *</small>
                                    <input  class="form-control" name="quantity" value="001" readonly/>
                                    <span class="text-danger"><?php echo form_error('issue_date'); ?></span>
                                </div>
                                <div class="form-group col-md-4 col-sm-4">
                                    <label for="exampleInputEmail1">Nom du client</label><small class="req"> *</small>

                                    <select name="account_type" onchange="getIssueUser(this.value)"  id="input-type-student" class="form-control ac_type">
                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                        <?php
                                        foreach ($clients as $client_key => $client_value) {
                                            ?>


                         <!--input autofocus="" name="account_type" class="ac_type" id="input-type-student" value="<?php echo $client_value['id']; ?>" type="radio" /-->
                                            <option value="<?php echo $client_value['id']; ?>"><?php echo $client_value['item_supplier'] ?></option>

                                            <?php echo $client_value['item_suppliere']; ?>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="exampleInputEmail1">*</label><small class="req"> *</small>
                                            <div class="form-group">
                                                <button type="button" class="fa fa-plus" id="add_to_list"></button>
                                            </div>
                                        </div>
