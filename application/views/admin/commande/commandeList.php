...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-object-group"></i>Liste des bons commandes
        </h1>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Liste des bons commandes</h3>
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('commande', 'can_add')) {
                                ?>
                                <a href="<?php echo site_url('admin/commande/create') ?>" type="button" class="btn btn-primary btn-sm" ><i class="fa fa-plus"></i> Ajouter un bon de commande</a>
                            <?php }
                            ?>
