...
<script>
    ...
    function add_lesson() {
        ...
        $('#lesson_result').append('<div class="form-group" id="' + id + '"><label><?php echo $this->lang->line("lesson") . ' ' . $this->lang->line('name'); ?></label><small class="req"> *</small><br><input type="text" name="lessons[]" class="lessinput" /><input type="text" name="lessons[]" class="lessinput" /> <span  onclick="remove_lesson(' + id + ')" class="section_id_error text-danger">&nbsp;<i class="fa fa-remove"></i></span></div>');
