...
<div class="content-wrapper">  
    ...
    <section class="content">
        <div class="row">
                        ...
                        <form id="form1" action="<?php echo site_url('admin/complaint') ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo set_value('complaint'); ?>"  name="complaint">
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <input type="text" class="form-control" value="<?php echo set_value('source'); ?>"  name="source">
            ...
            if ($this->rbac->hasPrivilege('reclamation', 'can_add')) {
                echo "8";
            } else {
                echo "12";
            }
