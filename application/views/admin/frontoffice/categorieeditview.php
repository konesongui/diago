<div class="content-wrapper" style="min-height: 348px;">
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('categorie_salaire', 'can_add') || $this->rbac->hasPrivilege('categorie', 'can_edit')) { ?>
                <div class="col-md-4">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Editer une categorie salariale</h3>
                        </div><!-- /.box-header -->
                        <form id="form1" action="<?php echo site_url('admin/categorie/edit/' . $categorie_data['id']) ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">
                                <?php echo $this->session->flashdata('msg') ?>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Catégorie</label><small class="req"> *</small>
                                    <input type="text" class="form-control" value="<?php echo set_value('categorie', $categorie_data['categorie']); ?>" name="categorie">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo set_value('salaire', $categorie_data['salaire']); ?>" name="salaire">
                            ...
                            <div class="box-footer">
                                ...
                                <a href="<?php echo base_url() ?>admin/categorie" type="button" class="btn btn-primary btn-xs" style="width: 99px;height: 23px">
            ...
            if ($this->rbac->hasPrivilege('categorie_salaire', 'can_add') || $this->rbac->hasPrivilege('categorie_salaire', 'can_edit')) {
                echo "8";
            } else {
                echo "12";
            }
            ?>">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="download_label">Liste des catégorie</div>
                                    ...
                                    foreach ($categorie_list as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right">
                                                ...
                                                <a data-placement="left" href="<?php echo base_url(); ?>admin/categorie/edit/<?php echo $value['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                                ...
                                                <?php } else { ?>
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/categorie/delete/<?php echo $value['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" data-original-title="<?php echo $this->lang->line('delete'); ?>">
                                                        <i class="fa fa-remove"></i>
                                                    </a>
                                                <?php } ?>
                                            </td>
