<div class="content-wrapper">  
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('reclamation', 'can_add') || $this->rbac->hasPrivilege('reclamation', 'can_edit')) { ?>
                <div class="col-md-4">
                    <!-- Horizontal Form -->
                        ...
                        <form id="form1" action="<?php echo site_url('admin/complaint/edit/' . $complaint_data['id']) ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo set_value('complaint', $complaint_data['complaint']); ?>"  name="complaint">
            ...
            if ($this->rbac->hasPrivilege('reclamation', 'can_add') || $this->rbac->hasPrivilege('reclamation', 'can_edit')) {
                echo "8";
            } else {
                echo "12";
            }
