<div class="content-wrapper">  
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('courier_reçu', 'can_add') || $this->rbac->hasPrivilege('courier_reçu', 'can_edit')) { ?>
                <div class="col-md-4">
                    <!-- Horizontal Form -->
            ...
            if ($this->rbac->hasPrivilege('courier_reçu', 'can_add') || $this->rbac->hasPrivilege('courier_reçu', 'can_edit')) {
                echo "8";
            } else {
                echo "12";
            }
                                            ...
                                            <tr>                                              
                                                ...
                                                <td class="mailbox-date pull-right white-space-nowrap">
                                                    ...
                                                    <?php if ($value->image !== "") { ?><a data-placement="left" href="<?php echo base_url(); ?>admin/dispatch/download/<?php echo $value->image; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('download'); ?>">
                                                        ...
                                                        </a>  <?php } ?>   <?php if ($this->rbac->hasPrivilege('courier_reçu', 'can_edit')) { ?>
                                                    ...
                                                    <?php } if ($this->rbac->hasPrivilege('courier_reçu', 'can_delete')) { ?>
