<div class="content-wrapper">  
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('journal_appels', 'can_add') || $this->rbac->hasPrivilege('journal_appels', 'can_edit')) { ?>
                <div class="col-md-4">
                    <!-- Horizontal Form -->
    ...
    <?php } ?>
            ...
            if ($this->rbac->hasPrivilege('journal_appels', 'can_add') || $this->rbac->hasPrivilege('journal_appels', 'can_edit')) {
                echo "8";
            } else {
                echo "12";
            }
