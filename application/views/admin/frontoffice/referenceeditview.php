...
<div class="content-wrapper" style="min-height: 348px;">  
    ...
    <section class="content">
        <div class="row">
            ...
            <?php if ($this->rbac->hasPrivilege('parametre', 'can_add') || $this->rbac->hasPrivilege('parametre', 'can_edit')) { ?>
                <div class="col-md-4">
                    <!-- Horizontal Form -->
            ...
            if ($this->rbac->hasPrivilege('parametre', 'can_add') || $this->rbac->hasPrivilege('parametre', 'can_edit')) {
                echo "6";
            } else {
                echo "10";
            }
                                        ...
                                        foreach ($reference_list as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    <?php if ($this->rbac->hasPrivilege('parametre', 'can_edit')) { ?>
                                                    ...
                                                    <?php } if ($this->rbac->hasPrivilege('parametre', 'can_delete')) { ?>
