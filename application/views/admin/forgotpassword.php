            ...
            <div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
                ...
                <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                        ...
                        <!--begin::Form-->
                        <form class="form w-100"  id="kt_sign_in_form" method="post" action="<?php echo site_url('site/forgotpassword') ?>">
                            <!--begin::Heading-->
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Email-->
                                <input type="text" placeholder="<?php echo $this->lang->line('email'); ?>" name="email"  value="<?php echo set_value('username') ?>" class="form-username form-control" id="form-username" />
                            ...
                            <div class="d-grid mb-10">
                                <button class="btn btn-succes btn-login btn-block text-uppercase waves-effect waves-light" style="background-color: navy;color: white" type="submit">Envoyer</button>
