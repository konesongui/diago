    ...
    <div class="col-md-12">
        <div class="box box-primary border0 mb0 margesection">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-search"></i> Rapport des absences</h3>
            ...
            <div class="">
                <ul class="reportlists">
                    ...
                    if ($this->rbac->hasPrivilege('staff_attendance_report', 'can_view')) {
                        ...
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/attendance/staff_attendance_report'); ?>"><a href="<?php echo base_url() ?>admin/staffattendance/attendancereport"><i class="fa fa-file-text-o"></i> Rapport des absences</a></li>
                    <?php } ?>
                    <?php
                    if (is_subAttendence()) {
